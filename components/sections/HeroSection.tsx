      ...
      <div className="container-editorial min-h-[100dvh] grid lg:grid-cols-12 lg:gap-x-8">
        ...
        <div className="lg:col-span-5 xl:col-span-5 flex flex-col justify-between pt-28 pb-8 lg:pt-32 lg:pb-12 lg:min-h-[100dvh] z-10">
          <div className="flex-1 flex flex-col justify-center">
            ...
            <h1 className="font-display font-semibold tracking-[-0.05em] leading-[0.88]">
              {headlineLines.map((line, index) => (
                <span key={line} className="block overflow-hidden">
                  {reducedMotion ? (
                    <span className="block text-[clamp(2.75rem,6.5vw,5.25rem)] xl:text-[6rem]">
                      {line}
                    </span>
                  ) : (
                    <motion.span
                      ...
                      variants={lineReveal}
                      {...motionProps}
                      className="block text-[clamp(2.75rem,6.5vw,5.25rem)] xl:text-[6rem]"
                    >
                      {line}
                    </motion.span>
                  )}
            ...
            <motion.p
              ...
              variants={fadeUp}
              {...motionProps}
              className="mt-6 lg:mt-8 text-base md:text-lg text-muted-foreground leading-relaxed max-w-[40ch] text-balance"
            >
            ...
            >
              <Button href="#register" variant="primary" size="lg" magnetic>
                Reserve Your Seat
              ...
              <button
                ...
                className="inline-flex items-center gap-3 text-sm font-medium tracking-wide text-foreground group"
              >
        ...
        <div className="lg:col-span-7 xl:col-span-7 relative lg:min-h-[100dvh] flex flex-col justify-center pb-8 lg:pb-0 lg:py-16">
          <div className="relative w-full">
            <div className="relative aspect-[4/5] sm:aspect-[16/11] lg:aspect-auto lg:min-h-[72vh] xl:min-h-[78vh] overflow-hidden rounded-xl lg:rounded-2xl bg-mist">
              <Image
